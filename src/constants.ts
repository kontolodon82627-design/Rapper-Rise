...
export const NPC_ARTISTS = [
  ...
  { name: 'Elton John', basePoints: 400000, type: 'Pop' },
  { name: 'Jay-Z', basePoints: 390000, type: 'Rap' },
  { name: 'Tupac Shakur', basePoints: 380000, type: 'Rap' },
  { name: 'The Notorious B.I.G.', basePoints: 370000, type: 'Rap' },
  { name: 'Snoop Dogg', basePoints: 350000, type: 'Rap' },
  { name: 'Frank Sinatra', basePoints: 400000, type: 'Jazz' },
  { name: 'Bob Marley', basePoints: 410000, type: 'Reggae' },
  { name: 'Queen', basePoints: 450000, type: 'Rock' },
  { name: 'The Beatles', basePoints: 500000, type: 'Rock' },
  { name: 'The Rolling Stones', basePoints: 440000, type: 'Rock' },
  { name: 'Nirvana', basePoints: 390000, type: 'Rock' },
  { name: 'Metallica', basePoints: 380000, type: 'Rock' },
  { name: 'Red Hot Chili Peppers', basePoints: 350000, type: 'Rock' },
  { name: 'Pink Floyd', basePoints: 420000, type: 'Rock' },
  { name: 'Led Zeppelin', basePoints: 430000, type: 'Rock' },
  { name: 'AC/DC', basePoints: 410000, type: 'Rock' },
  { name: 'Gorillaz', basePoints: 320000, type: 'Alternative' },
  { name: 'Arctic Monkeys', basePoints: 340000, type: 'Rock' },
  { name: 'Paramore', basePoints: 310000, type: 'Rock' },
  { name: 'My Chemical Romance', basePoints: 290000, type: 'Rock' },
  { name: 'Daft Punk', basePoints: 380000, type: 'Electronic' },
  { name: 'David Guetta', basePoints: 340000, type: 'Electronic' },
  { name: 'Calvin Harris', basePoints: 350000, type: 'Electronic' },
  { name: 'Avicii', basePoints: 370000, type: 'Electronic' },
  { name: 'Tiesto', basePoints: 320000, type: 'Electronic' },
  { name: 'Martin Garrix', basePoints: 310000, type: 'Electronic' },
  { name: 'Marshmello', basePoints: 330000, type: 'Electronic' },
  { name: 'The Chainsmokers', basePoints: 300000, type: 'Electronic' },
  { name: 'Luke Combs', basePoints: 370000, type: 'Country' },
  { name: 'Morgan Wallen', basePoints: 390000, type: 'Country' },
  { name: 'Carrie Underwood', basePoints: 320000, type: 'Country' },
  { name: 'Garth Brooks', basePoints: 380000, type: 'Country' },
  { name: 'Shania Twain', basePoints: 350000, type: 'Country' },
  { name: 'Dolly Parton', basePoints: 360000, type: 'Country' },
  { name: 'Johnny Cash', basePoints: 390000, type: 'Country' },
  { name: 'Luke Bryan', basePoints: 310000, type: 'Country' },
  { name: 'Summer Walker', basePoints: 300000, type: 'R&B' },
  { name: 'H.E.R.', basePoints: 280000, type: 'R&B' },
  { name: 'Megan Thee Stallion', basePoints: 350000, type: 'Rap' },
  { name: 'Polo G', basePoints: 270000, type: 'Rap' },
  { name: 'Lil Uzi Vert', basePoints: 290000, type: 'Rap' },
  { name: 'Lil Baby', basePoints: 310000, type: 'Rap' },
  { name: 'Playboi Carti', basePoints: 280000, type: 'Rap' },
  { name: 'Benson Boone', basePoints: 240000, type: 'Pop' },
  { name: 'Teddy Swims', basePoints: 220000, type: 'Pop' },
  { name: 'Reneé Rapp', basePoints: 210000, type: 'Pop' }
];
